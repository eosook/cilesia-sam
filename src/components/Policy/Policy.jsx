      ...
      <div className="policy-list">
        <section className="policy-section">
          ...
          <p className="policy-section__body">
            ...
            who might say hellow from afar! Although they’ll be kept in a
        ...
        <section className="policy-section">
          ...
          <p className="policy-section__body">
            ...
            deposit, as well as a charge for 50% of the service booked. Failure
            to send payment will prevent future bookings.{" "}
          </p>
        </section>
        ...
        <section className="policy-section">
          ...
          <p className="policy-section__body">
            ...
            within 48 hours so that we can address any concerns and make it
            right for you
          </p>
        </section>
        ...
        <section className="policy-section">
          ...
          <p className="policy-section__body">
            Please arrive on time. 15+ minutes late will result in cancellation
            of your appointment and 50% of the service charged.{" "}
          </p>
        </section>
